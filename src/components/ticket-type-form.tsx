...
// import { ticketFormSchema, type TicketFormValues } from "@/lib/schema";
...
//   { id: "VVIP", label: "VVIP ACCESSS", price: "$450", available: "5/52" },
// ];

// export default function TicketTypeForm({ onNext, currentStep, resetStep }: TicketTypeFormProps) {
...
//     if (savedData.ticketType) {
//       form.setValue("ticketType", savedData.ticketType);
//     }
//     if (savedData.quantity) {
//       form.setValue("quantity", savedData.quantity);
//     }
//   }, [form]);
...
//                               className={cn(
//                                 "relative w-full rounded-xl border border-teal p-4 text-left transition-all hover:border-teal/50 focus:border-teal focus:ring-teal focus:ring-offset-surface",
//                                 field.value === type.id
...
//                   type="button"
//                   variant="outline"
//                   className="w-full font-jeju h-12 border-teal text-teal bg-transparent hover:bg-teal/10"
//                 >
//                   Cancel
//                 </Button>
//                 <Button
...
//                   type="submit"
//                   className="w-full font-jeju h-12 bg-teal text-white hover:bg-teal-hover cursor-pointer"
//                 >
//                   Next
//                 </Button>
//               </div>
